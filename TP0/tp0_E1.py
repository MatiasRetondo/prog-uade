...
def cargaUser(matriz):
    ...
    while condicion == True:
        ...
        if legajo == 99999:
            ...
            while legajo < 10000 or legajo > 25000 or legajo in values:
...
def orderAndSlice(matriz):
    ...
    for i in range(len(matriz)):
        ...
        print("sueldo:", arrayAntiguedad , "antiguedad:", arraySueldo)
...
#El resto esta bien, menos el orderAndSlice que no esta ordenando bien, bah creo que no esta bien porque la matriz esta mal cargada
